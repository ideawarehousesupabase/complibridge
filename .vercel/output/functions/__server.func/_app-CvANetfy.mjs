...
import { S as Search, B as Bell, L as LayoutDashboard, $ as Users, w as FileText, d as Bot, q as CircleUser, T as Settings, V as ShieldCheck, G as Globe, J as LogOut, P as PanelLeft, a1 as X } from "./_libs/lucide-react.mjs";
...
function AppSidebar() {
  ...
  const items = [
    ...
    { to: "/portal", label: t("portal"), icon: CircleUser },
    { to: "/settings", label: t("settings"), icon: Settings }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard", className: "flex items-center gap-2 text-sidebar-foreground", children: [
      ...
      !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold leading-tight", children: "CompliBridge" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-wider opacity-70", children: "AI Compliance" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: pathname === item.to || pathname.startsWith(item.to + "/"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.to, className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarFooter, { className: "p-3 space-y-3", children: [
      !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "size-4 text-sidebar-foreground/70" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: lang, onValueChange: (v) => setLang(v), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-8 bg-sidebar-accent border-sidebar-border text-sidebar-foreground text-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "mr", children: "मराठी" })
          ] })
        ] })
      ] }),
      user && !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-sidebar-accent/50 p-2 text-sidebar-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium truncate", children: user.fullName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] opacity-70 truncate", children: user.role })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarMenuButton, { onClick: () => {
        logout();
        navigate({ to: "/" });
      }, className: "text-sidebar-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { className: "size-4" }),
        !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t("logout") })
      ] })
    ] })
  ] });
}
function AppLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex w-full bg-muted/30", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-16 border-b bg-background/80 backdrop-blur flex items-center gap-4 px-4 sticky top-0 z-30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarTrigger, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-2 flex-1 max-w-md", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "size-4 text-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search workers, alerts, documents…", className: "border-0 bg-muted/50 focus-visible:ring-0" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 md:hidden" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "relative size-9 grid place-items-center rounded-lg hover:bg-muted", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "size-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-gradient-hero text-primary-foreground text-xs", children: user?.fullName?.split(" ").map((n) => n[0]).join("").slice(0, 2).toUpperCase() ?? "U" }) })
      ] }),
